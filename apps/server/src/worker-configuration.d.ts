/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 3edc54c951340d05192972536dcdf17e)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: string;
	EVM_ADDRESS: string;
	FACILITATOR_URL: string;
	API_COORDINATOR: DurableObjectNamespace<import("./worker").ApiCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ApiCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "EVM_ADDRESS" | "FACILITATOR_URL">> {}
}
